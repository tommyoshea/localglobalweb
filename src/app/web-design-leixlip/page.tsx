...
const WebDesignLeixlip = () => {
  ...
  const benefits = [
    {
      icon: MapPin,
      title: 'Local Leixlip Focus',
      description: 'Designed specifically for Leixlip businesses and local customers',
      color: 'from-blue-400 to-cyan-500'
    },
    {
      icon: Phone,
    ...
    },
    {
      icon: Search,
      title: 'Local SEO',
      description: 'Optimized to appear in Leixlip Google searches',
      color: 'from-emerald-400 to-teal-500'
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      description: 'Dedicated support to help your Leixlip business grow',
  ...
  const testimonials = [
    {
      name: 'Sarah O\'Brien',
      business: 'O\'Brien\'s Hair Salon, Leixlip',
      text: 'Tommy created an amazing website for our salon. The local SEO has brought in so many new customers from Leixlip and surrounding areas!',
      rating: 5
    },
    {
      name: 'Michael Murphy',
      business: 'Murphy\'s Plumbing, Leixlip',
      text: 'Professional service and our new website has helped us compete with bigger companies. Tommy was great to work with!',
      rating: 5
    },
    {
      name: 'Emma Walsh',
      business: 'Walsh\'s Flower Shop, Leixlip',
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-cyan-100 mb-10 leading-relaxed">
                Get your Leixlip business online with 
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mb-12">
                <button
                  ...
                  className="group bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-green-500/25 inline-flex items-center justify-center"
                  tabIndex={0}
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
                <div className="flex items-center text-cyan-200">
                  ...
                  <span className="font-semibold">Local Leixlip Expert</span>
                </div>
                <div className="flex items-center text-cyan-200">
      ...
      {/* Why Choose Tommy for Leixlip Web Design Section */}
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              ...
              Why Choose Tommy for Leixlip Web Design?
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Your Leixlip business deserves a professional online presence. 
              <span className="text-green-600 font-semibold"> Call Tommy at 0892781782</span> for expert web design services.
            </p>
          </div>
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              ...
              Leixlip Business Success Stories
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8">
              <span className="bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
                What Leixlip Businesses
              </span>
              <br />
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Don't just take our word for it. Here's what Leixlip businesses say about 
              <span className="text-green-600 font-semibold"> Tommy's web design services</span>.
            </p>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container-max relative z-10 text-center text-white">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6">
            Ready for Web Design Leixlip?
          </h2>
          
          <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
            Join successful Leixlip businesses who've already taken their business online with 
...
export default WebDesignLeixlip
