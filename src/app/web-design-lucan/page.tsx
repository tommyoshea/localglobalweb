...
const WebDesignLucan = () => {
  ...
  const benefits = [
    {
      icon: MapPin,
      title: 'Local Lucan Focus',
      description: 'Designed specifically for Lucan businesses and local customers',
      color: 'from-blue-400 to-cyan-500'
    },
    {
      icon: Phone,
    ...
    },
    {
      icon: Search,
      title: 'Local SEO',
      description: 'Optimized to appear in Lucan Google searches',
      color: 'from-emerald-400 to-teal-500'
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      description: 'Dedicated support to help your Lucan business grow',
  ...
  const testimonials = [
    {
      name: 'Lisa O\'Neill',
      business: 'O\'Neill\'s Hair Salon, Lucan',
      text: 'Tommy created an amazing website for our salon. The local SEO has brought in so many new customers from Lucan and surrounding areas!',
      rating: 5
    },
    {
      name: 'Tommy Walsh',
      business: 'Walsh\'s Butcher Shop, Lucan',
    ...
    {
      name: 'Mary O\'Connor',
      business: 'O\'Connor\'s Flower Shop, Lucan',
      text: 'Our website has made it so easy for customers to find us and order online. Highly recommend Tommy\'s services!',
      rating: 5
    }
  ]
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen bg-gradient-to-br from-emerald-900 via-blue-900 to-purple-900 overflow-hidden">
        ...
        <div className="container-max section-padding relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-400 to-blue-500 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              ...
              <p className="text-xl md:text-2xl text-cyan-100 mb-10 leading-relaxed">
                Get your Lucan business online with 
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mb-12">
                <button
                  ...
                  className="group bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-emerald-500/25 inline-flex items-center justify-center"
                  tabIndex={0}
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
                <div className="flex items-center text-cyan-200">
                  ...
                  <span className="font-semibold">Local Lucan Expert</span>
                </div>
                <div className="flex items-center text-cyan-200">
      ...
      {/* Why Choose Tommy for Lucan Web Design Section */}
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              <Heart className="w-5 h-5 mr-2 animate-pulse" />
              Why Choose Tommy for Lucan Web Design?
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Your Lucan business deserves a professional online presence. 
              <span className="text-emerald-600 font-semibold"> Call Tommy at 0892781782</span> for expert web design services.
            </p>
          </div>
      ...
      {/* Statistics Section */}
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-emerald-900 to-blue-900 overflow-hidden">
        <div className="absolute inset-0">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-emerald-50"></div>
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-r from-emerald-200 to-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              ...
              Lucan Business Success Stories
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8">
              <span className="bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
                What Lucan Businesses
              </span>
              <br />
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Don't just take our word for it. Here's what Lucan businesses say about 
              <span className="text-emerald-600 font-semibold"> Tommy's web design services</span>.
            </p>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container-max relative z-10 text-center text-white">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6">
            Ready for Web Design Lucan?
          </h2>
          
          <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
            Join successful Lucan businesses who've already taken their business online with 
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              onClick={handleCallTommy}
              className="group bg-white text-emerald-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-white/25 inline-flex items-center"
              tabIndex={0}
