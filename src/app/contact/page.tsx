...
function ContactForm() {
  ...
  const packages = [
    { value: 'starter', label: 'Starter Package - €299', description: 'Perfect for small businesses getting started online' },
    { value: 'professional', label: 'Professional Package - €599', description: 'Ideal for growing businesses with more content needs' },
    { value: 'premium', label: 'Premium Package - €999', description: 'Complete solution for established businesses' },
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            <p className="text-sm font-bold text-green-800">
                              Package Selected: {packages.find(p => p.value === formData.package)?.label}
                            </p>
                            <p className="text-xs text-green-600">
                              {packages.find(p => p.value === formData.package)?.description}
                            </p>
                          </div>
                        </div>
                      </motion.div>
                    ...
                    <label htmlFor="package" className="block text-sm font-bold text-gray-700 mb-2">
                      Web Design Package
                    </label>
                    <select
                      id="package"
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200 bg-white/50 backdrop-blur-sm ${
                        formData.package ? 'border-green-300 bg-green-50' : 'border-gray-300'
                      }`}
                    >
