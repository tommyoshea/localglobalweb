...
const WebDesignMaynooth = () => {
  ...
  const benefits = [
    {
      icon: MapPin,
      title: 'Local Maynooth Focus',
      description: 'Designed specifically for Maynooth businesses and local customers',
      color: 'from-blue-400 to-cyan-500'
    },
    {
      icon: Phone,
    ...
    },
    {
      icon: Search,
      title: 'Local SEO',
      description: 'Optimized to appear in Maynooth Google searches',
      color: 'from-emerald-400 to-teal-500'
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      description: 'Dedicated support to help your Maynooth business grow',
  ...
  const testimonials = [
    {
      name: 'James O\'Connor',
      business: 'O\'Connor\'s Restaurant, Maynooth',
      text: 'Tommy created an amazing website for our restaurant. The local SEO has brought in so many new customers from Maynooth and surrounding areas!',
      rating: 5
    },
    {
      name: 'Maria Kelly',
      business: 'Kelly\'s Law Firm, Maynooth',
      text: 'Professional service and our new website has helped us establish credibility. Tommy was great to work with throughout the process!',
      rating: 5
    },
    {
      name: 'David Murphy',
      business: 'Murphy\'s Auto Repair, Maynooth',
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-cyan-100 mb-10 leading-relaxed">
                Get your Maynooth business online with 
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mb-12">
                <button
                  ...
                  className="group bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-purple-500/25 inline-flex items-center justify-center"
                  tabIndex={0}
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
                <div className="flex items-center text-cyan-200">
                  ...
                  <span className="font-semibold">Local Maynooth Expert</span>
                </div>
                <div className="flex items-center text-cyan-200">
      ...
      {/* Why Choose Tommy for Maynooth Web Design Section */}
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              <Heart className="w-5 h-5 mr-2 animate-pulse" />
              Why Choose Tommy for Maynooth Web Design?
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Your Maynooth business deserves a professional online presence. 
              <span className="text-purple-600 font-semibold"> Call Tommy at 0892781782</span> for expert web design services.
            </p>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-purple-50"></div>
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-r from-purple-200 to-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-r from-pink-200 to-yellow-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>

        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              <Star className="w-5 h-5 mr-2 animate-pulse" />
              Maynooth Business Success Stories
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8">
              <span className="bg-gradient-to-r from-purple-600 via-blue-600 to-pink-600 bg-clip-text text-transparent">
                What Maynooth Businesses
              </span>
              <br />
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Don't just take our word for it. Here's what Maynooth businesses say about 
              <span className="text-purple-600 font-semibold"> Tommy's web design services</span>.
            </p>
          </div>
      ...
      {/* Final CTA Section */}
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-blue-600 to-pink-600"></div>
        ...
        <div className="container-max relative z-10 text-center text-white">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6">
            Ready for Web Design Maynooth?
          </h2>
          
          <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
            Join successful Maynooth businesses who've already taken their business online with 
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              onClick={handleCallTommy}
              className="group bg-white text-purple-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-white/25 inline-flex items-center"
              tabIndex={0}
...
export default WebDesignMaynooth
