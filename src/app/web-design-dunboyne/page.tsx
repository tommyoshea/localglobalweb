...
const WebDesignDunboyne = () => {
  ...
  const benefits = [
    {
      icon: MapPin,
      title: 'Local Dunboyne Focus',
      description: 'Designed specifically for Dunboyne businesses and local customers',
      color: 'from-cyan-400 to-blue-500'
    },
    {
      icon: Phone,
    ...
    },
    {
      icon: Search,
      title: 'Local SEO',
      description: 'Optimized to appear in Dunboyne Google searches',
      color: 'from-fuchsia-400 to-purple-500'
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      description: 'Dedicated support to help your Dunboyne business grow',
  ...
  const testimonials = [
    {
      ...
      business: 'O\'Reilly\'s Hardware Store, Dunboyne',
      text: 'Tommy created an amazing website for our hardware store. The local SEO has brought in so many new customers from Dunboyne and surrounding areas!',
      rating: 5
    },
    {
      name: 'Sarah O\'Connor',
      business: 'O\'Connor\'s Restaurant, Dunboyne',
    ...
    {
      name: 'Tommy Byrne',
      business: 'Byrne\'s Plumbing, Dunboyne',
    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-cyan-900 via-blue-900 to-indigo-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-r from-lime-400 to-green-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-gradient-to-r from-fuchsia-400 to-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-cyan-100 mb-10 leading-relaxed">
                Get your Dunboyne business online with 
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
                <div className="flex items-center text-cyan-200">
                  ...
                  <span className="font-semibold">Local Dunboyne Expert</span>
                </div>
                <div className="flex items-center text-cyan-200">
      ...
      {/* Why Choose Tommy for Dunboyne Web Design Section */}
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-cyan-50"></div>
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-r from-cyan-200 to-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-r from-lime-200 to-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>

        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              <Heart className="w-5 h-5 mr-2 animate-pulse" />
              Why Choose Tommy for Dunboyne Web Design?
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Your Dunboyne business deserves a professional online presence. 
              <span className="text-cyan-600 font-semibold"> Call Tommy at 0892781782</span> for expert web design services.
            </p>
          </div>
      ...
      {/* Statistics Section */}
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-cyan-900 to-blue-900 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 right-0 w-72 h-72 bg-gradient-to-r from-lime-400 to-green-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-r from-lime-200 to-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>

        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              <Star className="w-5 h-5 mr-2 animate-pulse" />
              Dunboyne Business Success Stories
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8">
              <span className="bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
                What Dunboyne Businesses
              </span>
              <br />
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Don't just take our word for it. Here's what Dunboyne businesses say about 
              <span className="text-cyan-600 font-semibold"> Tommy's web design services</span>.
            </p>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-600/90 via-blue-600/90 to-purple-600/90"></div>
        ...
        <div className="container-max relative z-10 text-center text-white">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6">
            Ready for Web Design Dunboyne?
          </h2>
          
          <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
            Join successful Dunboyne businesses who've already taken their business online with 
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              onClick={handleCallTommy}
              className="group bg-white text-cyan-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-white/25 inline-flex items-center"
              tabIndex={0}
...
export default WebDesignDunboyne
