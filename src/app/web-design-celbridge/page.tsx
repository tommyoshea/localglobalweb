...
const WebDesignCelbridge = () => {
  ...
  const benefits = [
    {
      icon: MapPin,
      title: 'Local Celbridge Focus',
      description: 'Designed specifically for Celbridge businesses and local customers',
      color: 'from-orange-400 to-red-500'
    },
    {
      icon: Phone,
    ...
    },
    {
      icon: Search,
      title: 'Local SEO',
      description: 'Optimized to appear in Celbridge Google searches',
      color: 'from-indigo-400 to-purple-500'
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      description: 'Dedicated support to help your Celbridge business grow',
  ...
  const testimonials = [
    {
      ...
      business: 'O\'Brien\'s Pharmacy, Celbridge',
      text: 'Tommy created an amazing website for our pharmacy. The local SEO has brought in so many new customers from Celbridge and surrounding areas!',
      rating: 5
    },
    {
      name: 'Sarah Murphy',
      business: 'Murphy\'s Café, Celbridge',
    ...
    {
      name: 'John Kelly',
      business: 'Kelly\'s Garage, Celbridge',
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen bg-gradient-to-br from-orange-900 via-red-900 to-pink-900 overflow-hidden">
        {/* Animated Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-orange-400 to-red-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
          <div className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-r from-teal-400 to-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="container-max section-padding relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-400 to-red-500 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
                <MapPin className="w-5 h-5 mr-2 animate-pulse" />
                📍 Web Design Celbridge
              </div>
              ...
              <p className="text-xl md:text-2xl text-orange-100 mb-10 leading-relaxed">
                Get your Celbridge business online with 
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mb-12">
                <button
                  ...
                  className="group bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-orange-500/25 inline-flex items-center justify-center"
                  tabIndex={0}
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
                <div className="flex items-center text-orange-200">
                  ...
                  <span className="font-semibold">Local Celbridge Expert</span>
                </div>
                <div className="flex items-center text-orange-200">
            ...
            <div className="grid grid-cols-1 gap-6">
              {businessTypes.map((business, index) => (
                <div
                  key={business.name}
                  className="group bg-white/10 backdrop-blur-sm border border-white/20 p-8 rounded-2xl shadow-xl hover:shadow-orange-500/25 transition-all duration-300"
                >
                  ...
                  <p className="text-orange-100">{business.description}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Why Choose Tommy for Celbridge Web Design Section */}
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-orange-50"></div>
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-r from-orange-200 to-red-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-r from-teal-200 to-cyan-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>

        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              <Heart className="w-5 h-5 mr-2 animate-pulse" />
              Why Choose Tommy for Celbridge Web Design?
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Your Celbridge business deserves a professional online presence. 
              <span className="text-orange-600 font-semibold"> Call Tommy at 0892781782</span> for expert web design services.
            </p>
          </div>
      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-orange-900 to-red-900 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-r from-orange-400 to-red-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"></div>
          <div className="absolute bottom-0 right-0 w-72 h-72 bg-gradient-to-r from-teal-400 to-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
        ...
        <div className="container-max relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-orange-100 text-lg">of customers search online first</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-black text-white mb-4">46%</div>
              <div className="text-orange-100 text-lg">of searches are local</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-black text-white mb-4">78%</div>
              <div className="text-orange-100 text-lg">of local searches lead to purchases</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-black text-white mb-4">2x</div>
              <div className="text-orange-100 text-lg">higher revenue with website</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-orange-50"></div>
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-r from-orange-200 to-red-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-r from-teal-200 to-cyan-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>

        <div className="container-max relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-full text-sm font-bold mb-8 shadow-lg">
              <Star className="w-5 h-5 mr-2 animate-pulse" />
              Celbridge Business Success Stories
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8">
              <span className="bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 bg-clip-text text-transparent">
                What Celbridge Businesses
              </span>
              <br />
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Don't just take our word for it. Here's what Celbridge businesses say about 
              <span className="text-orange-600 font-semibold"> Tommy's web design services</span>.
            </p>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container-max relative z-10 text-center text-white">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6">
            Ready for Web Design Celbridge?
          </h2>
          
          <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
            Join successful Celbridge businesses who've already taken their business online with 
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              onClick={handleCallTommy}
              className="group bg-white text-orange-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-white/25 inline-flex items-center"
              tabIndex={0}
...
export default WebDesignCelbridge
